...
static tMemoryPool*    g_pMemPoolIns = nullptr;
...
{
    g_pMemPoolIns = g_pMemPoolIns == nullptr ? new tMemoryPool() : g_pMemPoolIns;
...
tMemoryPool* tEngine::getMemoryPoolIns()
{
    return g_pMemPoolIns;
}
